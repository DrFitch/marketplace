...
import { TiSocialFacebook, TiSocialLinkedin, TiSocialTwitter, TiSocialInstagram, TiArrowSortedDown, TiArrowSortedUp } from 'react-icons/ti';
    ...
    return (
        <div className={Style.siderBar}>
            ...
            <div className={Style.sideBar_menu}>
                <div className={Style.sideBar_box} onClick={() => openDiscoverMenu()}>
                    <p>Discover</p>
                    <TiArrowSortedDown />
                </div>
